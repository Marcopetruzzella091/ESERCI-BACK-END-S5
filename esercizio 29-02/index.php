...
<h1 class="text-center">Dati da inserire</h1>

<form id="myForm" class="w-50 m-auto mt-5" method="post" action="controller.php">
  <div class="mb-3">
  ...
  <button type="submit" class="btn btn-primary mie" data-action="insert">Scrivi sul DB</button>
  <button type="submit" class="btn btn-primary mie" data-action="insert_csv">Aggiungi al CSV</button>
</form>
...
document.getElementById("myForm").addEventListener("submit", function(event) {
    ...
    form.action = "controller.php?action=" + action;
});
</script>
</body>
</html>
